...
Next after publishing and deploying `contract_b`, let's take this a step further and create third contract.
...
Coming soon autogenerated init method forms for when deploying. Then autogenerated forms for any deployed contract!
